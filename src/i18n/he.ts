...
export const he = {
  ...
  manualFood: {
    ...
    per100gSubtitle: 'העתק מהטבלה התזונתית על האריזה — העמודה של 100 גרם',
    caloriesLabel: 'קלוריות',
    proteinLabel: 'חלבון (גרם)',
    fatLabel: 'שומן (גרם)',
    carbsLabel: 'פחמימות (גרם)',
    fiberLabel: 'סיבים תזונתיים (גרם, לא חובה)',
    servingSectionLabel: 'מידה נוספת באריזה (כוס, מנה, פרוסה)',
    servingSectionSubtitle: 'אם יש — מלא שם ומשקל בגרמים',
    ...
    caloriesOnlyToggle: 'הוסף רק קלוריות (ללא פירוט מאקרו)',
    caloriesOnlyHint:
      'אם לא ידועים לך ערכי החלבון/שומן/פחמימות, סמן כדי לדלג. הם לא יספרו בסיכום המאקרו היומי.',
    errors: {
